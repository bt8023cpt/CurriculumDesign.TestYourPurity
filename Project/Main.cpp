...
/** 
 * @Description 构造函数，初始化answerType对象
 */
answerType::answerType(string s, string s1, string s2, string s3, string s4, string s5)
{
	typeName = s;
	typeDetail[0] = s1;
	typeDetail[1] = s2;
...
void Test::testing(Test*test,answerType*answer)
{
	testChangeGrid();
	displayGrid();
	int i;
